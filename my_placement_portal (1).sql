...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2025 at 09:27 AM
...
INSERT INTO `applications` (`id`, `student_id`, `job_id`, `applied_on`, `application_status`) VALUES
(8, 1, 14, '2025-03-24 13:21:29', 'Pending'),
(9, 1, 15, '2025-03-25 06:11:22', 'Pending');
...
(8, 'aaaaaaaa', 'E-commerce', 'aaaaaaaa@gmail.com', '02394579856', 'https://www.google.com');
...
(14, 'Backend Engineer', 'Build scalable APIs and database systems', 'Hyderabad', 0.00, 'MCA, SQL, Node.js, Java', '2025-04-12', '2025-03-22 08:34:46', NULL, 'Amazon', 'https://erp.moderncoe.edu.in/login.aspx'),
...
(16, 'Data Analyst', 'Analyze and interpret complex data', 'Chennai', 60000.00, 'MCA, SQL, Python, Data Visualization', '2025-03-26', '2025-03-22 08:40:57', NULL, 'IBM', ''),
(17, 'Software Developer', 'frontend and backend development', '', 0.00, 'java\r\n', '2025-03-27', '2025-03-24 13:00:00', NULL, 'aaaaaaaa', '');
...
INSERT INTO `notices` (`id`, `title`, `content`, `posted_by`, `posted_at`) VALUES
(1, ' Notice for Placement Opportunities', 'All eligible students are hereby informed that the placement process for [Year] has commenced. Interested candidates must register with the placement cell and submit their updated resumes by [Deadline Date]. Companies from various sectors will be visiting the campus for recruitment. Stay updated with the placement schedule and guidelines. For further details, contact the placement office.', 8, '2025-03-26 07:38:27'),
(2, 'NITICE', 'All eligible students are hereby informed that the placement process for [Year] has commenced. Interested candidates must register with the placement cell and submit their updated resumes by [Deadline Date]. Companies from various sectors will be visiting the campus for recruitment. Stay updated with the placement schedul', 8, '2025-03-26 07:40:34');
...
INSERT INTO `skills` (`id`, `student_id`, `skill_name`) VALUES
(11, 1, 'java');
...
(1, 817493, 0, '2025-03-22', 'xxxxxx', 'aaaaaaa', 'aaaaaaa', 'aaaaa', 0, 0, 0, 0, '', 78, 0, 0, 'dipali_gode_mca@modercoe.edu.in', '2025-03-25 16:11:05', 'placed', '', 'Namrata', 'Kapse', '1234567890'),
(2, 247927, 0, '0000-00-00', '', '', '', '', 0, 0, 0, 0, '', 0, 0, 0, '', '', 'placed', '', 'Aaa', 'Aaa', ''),
(3, 519318, 0, '0000-00-00', '', '', '', '', 0, 0, 0, 0, '', 0, 0, 0, '', '', 'placed', '', 'Aakash', 'Girhe', '');
...
INSERT INTO `students_academic` (`id`, `student_id`, `semester`, `cgpa`, `backlog`, `certifications`, `recorded_at`) VALUES
(7, 1, 7, 9.70, 0, 'uploads/certifications/Placement.docx', '2025-03-26 06:11:12'),
(8, 1, 7, 9.70, 0, 'uploads/certifications/Placement.docx', '2025-03-26 06:11:29');
...
(8, 988363, 'Dipali', 'Gode', 'pune', '', '', '', '', '', '', '', '2025-03-26 07:58:22', '11111111');
...
(519318, '$2y$10$KRTZiTPSs.GukO8VF3uaaOR9s0It2tzPdQeoI9C4dJswiiknmrPU2', 'aakashgirhe289@gmail.com', '2025-03-24 12:50:29'),
